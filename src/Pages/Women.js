    ...
    <>
        <div className = 'text-stone-500'>
            ...
            <div className = 'flex flex-col sm:flex-row justify-center items-center p-2'>
                <div className ='ml-8'>
                    <Link to = "/women/fashion" className = ''><img loading = 'lazy' className = ' h-80 w-60 rounded-lg' src={W3}/></Link>
                    <h1 className = 'text-lg p-3 text-center'>WESTERN</h1>
                </div>
                <div className = 'ml-8'>
                    <Link to = "/women/fashion" className = ''><img loading = 'lazy' className = ' h-80 w-60 rounded-lg' src={W1}/></Link>
                    <h1 className = 'text-lg p-3 text-center'>INDIAN</h1>
                </div>
                <div className = 'ml-8'>
                    <Link to = "/women/fashion"><img loading = 'lazy' className = ' h-80 w-60 rounded-lg' src={W2}/></Link>
                    <h1 className = 'text-lg p-3 text-center'>FASHION</h1>
                </div>
                <div className = 'ml-8'>
                    <Link to = "/women/fashion" className = ''><img loading = 'lazy' className = ' h-80 w-60 rounded-lg ' src={W4}/></Link>
